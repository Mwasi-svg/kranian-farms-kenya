...
import { useForm } from "react-hook-form"; // Assuming ChevronLeft is from lucide-react
    ...
    <div className="min-h-screen flex flex-col">
      {location.pathname !== '/' && (
        <button
          ...
          aria-label="Go back"
        >
          {/* Assuming ChevronLeft is imported from lucide-react */}
          {/* Replace with your preferred back icon component */}
